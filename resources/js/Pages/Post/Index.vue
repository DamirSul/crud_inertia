<template>
        ...
        <div class="mb-8">
            <Link :href="route('post.create')" class="hover: bg-white hover: text-sky-500 border border-b-emerald-600 bg-sky-500 rounded-full text-center text-black w-32 block p-2">Add Post</Link>
        </div>
        <div v-if="posts">
